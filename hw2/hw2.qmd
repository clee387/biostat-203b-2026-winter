...
awk -F, 'NR==1 || $2==50862 || $2==50912 || $2==50971 || $2==50983 || $2==50902 || $2==50882 || $2==51221 || $2==51301 || $2==50931 {print $1","$2","$3","$5}' | \
...
time_filtered <- system.time({
  labevents_filtered <- read_csv(file)
})

time_filtered

# Check memory usage
lobstr::obj_size(labevents_filtered)
