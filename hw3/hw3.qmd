...
#Find mimic path - check which one exists
...
-   I used a mix of GPT-5 and also Claude Sonnet 4.5. I used both models when I had errors with creating the parquet. It kept giving me methods where my computer would max out storage and so these are all the times when I had to ask for help in debugging. It did not give me the most efficient ways to solve this problem so I got stuck on problems where I needed to be able to create the parquet.

-   They did not really help increase my productivity because the code they gave me produced the same errors of maxing out my storage and point to a different directory making my work even more confusing where I would get lost in my own code.
