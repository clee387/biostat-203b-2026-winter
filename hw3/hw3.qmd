...
# Graph 3: Box plot (no x-axis limit needed)
p3 <- ggplot(stays_per_subject, aes(y = n_stays)) +
  geom_boxplot(fill = "steelblue") +
  scale_y_continuous(limits = c(0, 50)) +  # Limit y-axis to 0-30
  labs(
    title = "Box Plot of ICU Stays per Subject",
