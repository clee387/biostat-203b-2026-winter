...
- The following command overwrites the previous file with new content as new file test1.txt with "hello, world"
...
- The following file appends/adds a new file test2.txt if it doesn't exist
- If it already exists, it adds the line to the end without deleting the previous content 
```{bash}
#| eval: false
