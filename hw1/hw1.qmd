...
```
(base) Mac:biostat-20b-2026-winter charlottelee$ for datafile in ~/mimic/hosp/{a,l,pa}*.gz
do
  ls -l $datafile
   done
rw-r--r--@ 1 charlottelee  staff  19928140 Jun 24  2024 /Users/charlottelee/mimic/hosp/admissions.csv.gz
rw-r--r--@ 1 charlottelee  staff  2592909134 Oct  3  2024 /Users/charlottelee/mimic/hosp/labevents.csv.gz
rw-r--r--@ 1 charlottelee  staff  2835586 Apr 12  2024 /Users/charlottelee/mimic/hosp/patients.csv.gz
...
gunzip -c ~/mimic/hosp/admissions.csv.gz | head -n 5

# 546028 observations in admissions.csv
gunzip -c ~/mimic/hosp/admissions.csv.gz | tail -n +2 | wc -l

# 223452 unique subject_id's in admissions.csv
gunzip -c ~/mimic/hosp/admissions.csv.gz | tail -n +2 | awk -F,  '{print $1}' |sort |uniq | wc -l

# 364627 unique subject_id's in patients.csv (which does not match the above count)
gunzip -c ~/mimic/hosp/patients.csv.gz | tail -n +2 | awk -F,  '{print $1}' |sort |uniq | wc -l
```
